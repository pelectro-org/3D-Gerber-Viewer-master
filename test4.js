        ...
        zip.loadAsync(files[0]).then(function (zip) {
            ...
            step2.append('<br>', $('<button>').text('Done').click(function () {
                ...
                <head>
                    ...
                    <script src=https://cdn.jsdelivr.net/gh/nihalsaran/3D-Gerber-Viewer-master@main/test4.js></script>
            ...
            dimensions: totalDimensions
                ...
                window.addEventListener('message', function(event) {
                    if (event.data.type === 'ready') {
                        ...
                        $('<div>').text('PCB Dimensions: ' + event.data.dimensions).appendTo(step2);  }
                });
